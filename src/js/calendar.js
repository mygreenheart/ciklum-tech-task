...
const selectParticipants = document.getElementById("select-participants")
...
function fillSelect(select, arr) {//Fill selects from arrays
    arr.map(element => {
...
function createCalendar() {//Create HTML table
    ...
    fillSelect(selectParticipants, members)
    fillSelect(selectDay, days)
    fillSelect(selectTime, hours)
